...
\titlegraphic{\includegraphics[scale=0.2]{images/ensta-couleur}
}
...
\begin{itemize}
\item Premier point
\item Second point\footfullcite{Feynman1941}
\end{itemize}
\end{alertblock}
\end{frame}
